...
class SSBPlayerSlider: UISlider {
    ...
    func configureSlider() {
        ...
        let normalThumbImage = thumbImage.newImage(scaledToSize: .init(width: 15, height: 15))
        setThumbImage(normalThumbImage, for: .normal)
        let highlightedThumbImage = thumbImage.newImage(scaledToSize: .init(width: 20, height: 20))
